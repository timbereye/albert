...
predict_feature_file_gs=$data_root"/features/tf.record.test2"
predict_feature_left_file_gs=$data_root"/features/features2.pkl.1"
predict_example_file_gs=$data_root"/features/examples2.pkl.1"
