...
output_dir_gs=$data_root"/output_drop"
train_file_gs=""
predict_file_gs=""
train_feature_file_gs=$data_root"/features_drop/tf.record.train.1"
...
tag_info_file_gs=$data_root"/features_drop/tag_info.yaml.1"
