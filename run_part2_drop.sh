...
output_dir_gs=$data_root"/output_drop_part2"
train_file_gs=""
predict_file_gs=""
train_feature_file_gs=$data_root"/features_drop/tf.record.train.2"
predict_feature_file_gs=$data_root"/features_drop/tf.record.test.2"
predict_feature_left_file_gs=$data_root"/features_drop/features.pkl.2"
predict_example_file_gs=$data_root"/features_drop/examples.pkl.2"
init_checkpoint_gs=$pretrained_models"/model.ckpt-best"
vocab_file_gs=$pretrained_models"/vocab_chinese.txt"
tag_info_file_gs=$data_root"/features_drop/tag_info.yaml.2"
