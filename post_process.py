                    ...
                    if key_ind in event_type_dct:
                        ...
                        if part2_result:
                            ...
                            for role, info in part2_result.items():
                                info_sorted = sorted(info, key=lambda x:x["score"], reverse=True)
                                argument = info_sorted[0]["text"]
            ...
            for line in ft:
                ...
                if result:
                    ...
                    for event_type, center_words in result.items():
                        ...
                        output_json = {"id": key_new, "text": text + "[SEP]" + event_type, "event_type": event_type,
                                       "center_word": {"start": center_word_start,
                                                       "end": center_word_end,
